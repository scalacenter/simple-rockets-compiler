...
val RollInput: AssignableCraftProperty = CraftProperty("roll", "set-input")
val PitchInput: AssignableCraftProperty = CraftProperty("pitch", "set-input")
val YawInput: AssignableCraftProperty = CraftProperty("yaw", "set-input")
val Brake: AssignableCraftProperty = CraftProperty("brake", "set-input")
val Slider1: AssignableCraftProperty = CraftProperty("slider1", "set-input")
val Slider2: AssignableCraftProperty = CraftProperty("slider2", "set-input")
val Slider3: AssignableCraftProperty = CraftProperty("slider3", "set-input")
val Slider4: AssignableCraftProperty = CraftProperty("slider4", "set-input")
val TranslateForward: AssignableCraftProperty = CraftProperty("translateForward", "set-input")
val TranslateRight: AssignableCraftProperty = CraftProperty("translateRight", "set-input")
val TranslateUp: AssignableCraftProperty = CraftProperty("translateUp", "set-input")
val TranslationMode: AssignableCraftProperty = CraftProperty("translationMode", "set-input")
